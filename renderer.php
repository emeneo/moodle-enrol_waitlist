...
class core_waitlist_renderer extends plugin_renderer_base {
     ...
     * @return string
     */
    public function render_course_waitlist_users_table(course_waitlist_users_table $table,
            moodleform $mform) {
...
class course_waitlist_table extends html_table implements renderable {
    ...
    /**
     * The default sort, options are course_waitlist_table::$sortablefields
     * Default: lastname
     */
    ...
    /**
     * The sort field for this table, should be one of course_waitlist_table::$sortablefields
     * @var string
     */
    public $sort;
 ...
 */
class course_waitlist_users_table extends course_waitlist_table {
